...
CREATE TABLE SILVERS_HOTEL_BOOKING (
    booking_id VARCHAR,
    hotel_id VARCHAR,
    hotel_city VARCHAR,
    customer_id VARCHAR,
...
INSERT INTO SILVERS_HOTEL_BOOKING
SELECT
    booking_id,
    hotel_id,
...
SELECT *
FROM SILVERS_HOTEL_BOOKING
LIMIT 10;

--making it business reardy
--objectives 
--show monthly revenue and monthly bokings
--analyze bookings by type and status
--display key KPIs

CREATE TABLE GOLDEN_DAILY_BOOKING AS
SELECT 
...
SELECT * FROM GOLDEN_DAILY_BOOKING LIMIT 30;

SELECT * FROM GOLD_HOTEL_CITY_SALES LIMIT 30;